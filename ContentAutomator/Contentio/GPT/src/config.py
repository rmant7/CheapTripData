...
SEO_CITY_ATTRACTIONS_DIR = Path(SEO_TEXTS_DIR/'seo_city_attractions/en')
SEO_CITY_ATTRACTIONS_BENGALI = Path(SEO_TEXTS_DIR/'city_attractions_bengali')
SEO_CHILDREN_ATTRACTIONS_DIR = Path(SEO_TEXTS_DIR/'seo_children_attractions/en')
SEO_ACCOMODATIONS_DIR = Path(SEO_TEXTS_DIR/'seo_accomodations/en')
SEO_TRANSPORTATIONS_DIR = Path(SEO_TEXTS_DIR/'seo_transportations/en')
SEO_FESTIVALS_DIR = Path(SEO_TEXTS_DIR/'seo_events_festivals/en')

# SMM folders setup
SMM_DIR = Path('../content/smm')
POSTS_DIR = Path(SMM_DIR/'posts')
SMM_CITY_ATTRACTIONS_FP_DIR = Path(SMM_DIR/'city_attractions_first_person_en')
