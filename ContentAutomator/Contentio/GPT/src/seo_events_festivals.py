...
from config import PROMPTS_DIR, SEO_CHILDREN_ATTRACTIONS_DIR, CHILDREN_ATTRACTIONS_LIST_DIR, IMG_DIR, OPTION_LISTS_DIR
...
def change_to():
    ...
    for city, country in cities_countries:
        ...
        try:
            ...
            attr_path = f'{OPTION_LISTS_DIR}/events_festivals/{city_}.json'
